...
class ClientFile:
   ...
   def get_files(self, filename):
       nearby_server = min(self.servers_nearby, key=self.servers_nearby.get)  # Minimum distance calculation based on the assumed values
       try:
           target_server = f"http://{nearby_server}:8080"  # once nearby server has been identified it is used to make a call here
